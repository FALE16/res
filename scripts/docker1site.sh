...
echo '========================================='
echo '=== PASO 9: CLONAR REPOSITORIOS DE SITIOS WEB  (EN LUGAR DEL PASO 9) <================'
echo '========================================='

sudo git clone https://github.com/Flicomastic/powerjgym.git #clona el sitio web

sudo mv powerjgym portal   #hace copia en portal
...
cd volumes
sudo git clone https://github.com/FALE16/deploys-mrsidm.git
sudo mv deploys-mrsidm deploy
...
docker-compose -f deploy/docker-compose1site.yml up -d
